...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SRICPT BY RIFKY             \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/rifstore/izinsc/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/rifstore/RifkyVVIP/main/"
start=$(date +%s)
secs_to_human() {
...
echo "RIFKY STORE" > /etc/xray/username
echo ""
elif [[ $host == "2" ]]; then
...
wget raw.githubusercontent.com/rifstore/RifkyVVIP/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
print_success "UDP-CUSTOM BY RIFKY STORE 57 VPN"
clear
...
print_success "NOOBZVPNS BY RIFKY STORE 57 VPN"
}
...
enable_services
restart_system
curl -sL "https://raw.githubusercontent.com/rifstore/RifkyVVIP/main/fix-all.sh" -o fix-all.sh
chmod +x fix-all.sh
./fix-all.sh
}
instal
